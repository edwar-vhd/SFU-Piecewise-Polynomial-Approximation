...
add wave -noupdate -group u_SpecialSquaringUnit /sfu_tb/DUT/uQuadraticInterpol/u_SpecialSquaringUnit_1/*
add wave -noupdate -group u_SpecialSquaringUnit /sfu_tb/DUT/uQuadraticInterpol/u_SpecialSquaringUnit_2/*
add wave -noupdate -group u_SpecialSquaringUnit /sfu_tb/DUT/uQuadraticInterpol/u_SpecialSquaringUnit_3/*

add wave -noupdate -group uFusedAccTree /sfu_tb/DUT/uQuadraticInterpol/uFusedAccTree_1/*
add wave -noupdate -group uFusedAccTree /sfu_tb/DUT/uQuadraticInterpol/uFusedAccTree_2/*
add wave -noupdate -group uFusedAccTree /sfu_tb/DUT/uQuadraticInterpol/uFusedAccTree_3/*
